...
import com.bcallanan.kstreamgreetingproducer.KafkaStreamApp;
import com.bcallanan.kstreamgreetingproducer.domain.Greeting;
import com.bcallanan.kstreamgreetingproducer.serdes.SerdesFactory;
...
public class KStreamTopology {
    ...
    public static KStream<String, Greeting> getGreetingKstream( StreamsBuilder streamBuilder ) {
         ...
         var /*KStream<String, GreetingSerdes>*/ greetingStream1 = streamBuilder
                .stream(GREETINGS1,
                        Consumed.with( Serdes.String(), SerdesFactory.greetingSerdesFactoryBuilder() ));
            
        //greetingStream1.print(Printed.< String, GreetingSerdes> toSysOut().withLabel(GREETINGS));
            
        var /*KStream<String, GreetingSerdes>*/ greetingStream2 = streamBuilder
                .stream(GREETINGS2,
                        Consumed.with( Serdes.String(), SerdesFactory.greetingSerdesFactoryBuilder() ));
        //greetingStream2.print(Printed.< String, GreetingSerdes> toSysOut().withLabel(GREETINGS2));

        var /*KStream<String, GreetingSerdes>*/ mergedStream = greetingStream1.merge( greetingStream2 ); //, (Named) GREETINGS2);
            
        //mergedStream.print(Printed.< String, GreetingSerdes> toSysOut().withLabel(GREETINGS_MERGED));
